import {
  ...
  now,
  deleteProps,
} from 'press-swiper-shared/shared/utils.js';
import {
  getSupport,
} from 'press-swiper-shared/shared/get-support.js';
import {
  getDevice,
} from 'press-swiper-shared/shared/get-device.js';
import {
  getBrowser,
} from 'press-swiper-shared/shared/get-browser.js';
...
class Swiper {
  ...
  emitContainerClasses() {
    ...
    const cls = swiper.native.contentClass.split(' ').filter(className => className.indexOf('swiper') === 0 || className.indexOf(swiper.params
  ...
  getSlideClasses(slideEl) {
    const swiper = this;
    return slideEl.slideClass.split(' ').filter(className => className.indexOf('swiper-slide') === 0 || className.indexOf(swiper.params
      .slideClass) === 0)
      .join(' ');
  }
