      ...
      <view class="header-content">
        <view class="header-content-info">
          <view class="logo">
            <image
              class="image"
              src="https://swiper.zebraui.com/logo.png"
              mode="widthFix"
            />
          </view>
        </view>
        <view class="header-content-button">
          <a
            class="button-item"
            href="https://swiper.zebraui.com/"
            target="_blank"
          >文档</a>
          <a
            class="button-item"
            href="https://ext.dcloud.net.cn/plugin?id=7273"
            target="_blank"
          >插件地址</a>
        </view>
      </view>
              ...
              <view class="item-content-list">
                ...
                <view class="content-list-item">
                  ...
                  <view class="item-right">
                    ...
                    <button
                      size="mini"
                      @click="confirmSlidesOffsetBefore()"
                    >
                      确定
                    </button>
                  </view>
                ...
                <view class="content-list-item">
                  ...
                  <view class="item-right">
                    ...
                    <button
                      size="mini"
                      @click="confirmSlidesOffsetAfter()"
                    >
                      确定
                    </button>
                  </view>
  ...
  methods: {
    ...
    radioChangeEnabled(value) {
      Object.assign(this.options, {
        enabled: value.detail.value == 'true',
      });
    ...
    radioChangeCenteredSlides(value) {
      Object.assign(this.options, {
        centeredSlides: value.detail.value == 'true',
      });
    },
    radioChangeCenteredSlidesBounds(value) {
      Object.assign(this.options, {
        centeredSlidesBounds: value.detail.value == 'true',
      });
    },
    radioChangeCenterInsufficientSlides(value) {
      Object.assign(this.options, {
        centerInsufficientSlides: value.detail.value == 'true',
      });
    },
    radioChangeLoop(value) {
      Object.assign(this.options, {
        loop: value.detail.value == 'true',
      });
    },
    ...
    .header-content {
      ...
      .header-content-button {
        ...
        .button-item {
          ...
          line-height: 48rpx;
          text-align: center;
          border: 1rpx solid hsla(0, 0%, 100%, 0.7);
          border-radius: 40rpx;
          cursor: pointer;
